            ...
            <el-row :gutter="20" class="tool-bar">
                <el-col :span="18">
                    <el-button size="mini" type="primary">
                        <i class="el-icon-circle-plus-outline" @click="initHostJoinGroupDialog()"></i>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            initHostJoinGroupDialog() {
                //call API. get can join group host list
                this.hostJoinGroupVisible = true;
                this.hostJoinGroup = {
